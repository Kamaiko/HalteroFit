...
// File: src/services/database/local/index.ts
import { User, Exercise, Workout, WorkoutExercise, ExerciseSet, WorkoutPlan, PlanDay, PlanDayExercise } from '@/models';

const database = new Database({
  adapter,
  modelClasses: [User, Exercise, Workout, WorkoutExercise, ExerciseSet, WorkoutPlan, PlanDay, PlanDayExercise],
});
